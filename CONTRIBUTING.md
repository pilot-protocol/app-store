...
Thanks for your interest in contributing to `app-store` — Pilot Protocol app store plugin — supervisor, broker, lifecycle audit.

## Quick start

```bash
git clone https://github.com/pilot-protocol/app-store.git
cd app-store
go test -race ./...
```
